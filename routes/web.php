...
Route::middleware(['admin_auth'])->group(function(){
    ...
    Route::get('homePage', [AuthController::class,'homePage'])->name('admin#homePage');
...
// User
    ...
    Route::group(['prefix'=>'user','middleware'=>'user_auth'],function(){
        ...
        Route::prefix('account')->group(function () {
            Route::get('accountViewPage',[UserController::class,'accountViewPage'])->name('user#accountViewPage');
